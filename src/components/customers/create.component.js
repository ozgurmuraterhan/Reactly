...
import { AddBox, ExpandMore, FileCopy, GroupAdd, ContactMail, Save } from "@material-ui/icons";
                     ...
                     <Grid item container sm={12}>
                        ...
                        <Grid container item sm={4} spacing={0}>
                           ...
                           <Grid container item sm={11} spacing={0}>
                              <FormGroup className="FormGroup">
                                 <InputLabel htmlFor="group_id" className="InputLabel" style={{ margin: "5px" }}>
                                    {" "}
                                 </InputLabel>
                                 <FormControl>
                                    <Select
                                    ...
                                    <FormControl>
                                       ...
                                       <Select
                                          ...
                                          onChange={(selectedOption) => {
                                             seTstate({
                                                ...state,
                                                selectedshippingAddressState2: selectedOption,
                                             });
                                          }}
                                       />
                                       <FormHelperText>{t("youNeedaStateName")}</FormHelperText>
