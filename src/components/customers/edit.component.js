...
export default function CustomerEdit(props) {
    ...
    function getCustomersData() {
        axios.get(`/customers/${props.match.params.id}`).then((response) => {
            ...
            seTstate({
                ...
                default_payment_method: [
                    {
                        label: response.data.default_payment_method[0].label,
                        value: response.data.default_payment_method[0]._id,
                    },
                ],
                ...
                selectedDefaultAddressCountryEdit: [
                    {
                        label: response.data.defaultAddress_country_id,
                        value: response.data.defaultAddress_country_id,
                    },
                ],
                selectedDefaultAddressStateEdit: [
                    {
                        label: response.data.defaultAddress_state_id,
                        value: response.data.defaultAddress_state_id,
                    },
                ],
                selectedBillingAddressCountryEdit2: [
                    {
    ...
    const onCopyDefaultAdressTObillingAdress = (e) => {
        ...
        seTstate({
            ...state,
            selectedBillingAddressCountryEdit2:
                state.selectedDefaultAddressCountryEdit,
            selectedBillingAddressStateEdit3:
                state.selectedDefaultAddressStateEdit,
    ...
    const onCopyBillingAdressTOshippingAdress = (e) => {
        ...
        seTstate({
            ...state,
            selectedShippingAddressCountryEdit2:
                state.selectedBillingAddressCountryEdit2,
            selectedShippingAddressStateEdit2:
                state.selectedBillingAddressStateEdit3,
    ...
    const onSubmit = (e) => {
        ...
        const Customers = {
            ...
            defaultAddress_country_id:
                state.selectedDefaultAddressCountryEdit[0].label,
            defaultAddress_state_id:
                state.selectedDefaultAddressStateEdit[0].label,
            ...
            billingAddress_country_id:
                state.selectedBillingAddressCountryEdit2[0].label,
            billingAddress_state_id:
                state.selectedBillingAddressStateEdit3[0].label,
            ...
            shippingAddress_country_id:
                state.selectedShippingAddressCountryEdit2[0].label,
            shippingAddress_state_id:
                state.selectedShippingAddressStateEdit2[0].label,
                                        ...
                                        <FormGroup className="FormGroupAddress">
                                            <FormControl>
                                                ...
                                                <Select
                                                    ...
                                                    options={
                                                        state.selectedDefaultStateArray
                                                    }
                                                    onChange={(
                                                        selectedOption
                                                    ) => {
                                            ...
                                            <FormGroup className="FormGroupAddress">
                                                <FormControl>
                                                    ...
                                                    <Select
                                                        ...
                                                        options={
                                                            state.selectedBillingStateArray
                                                        }
                                                        onChange={(
                                                            selectedOption
                                                        ) => {
                                            ...
                                            <FormGroup className="FormGroupAddress">
                                                <FormControl>
                                                    ...
                                                    <Select
                                                        ...
                                                        value={
                                                            state.selectedShippingAddressCountryEdit2
                                                        }
                                                        options={dataCountry}
                                                        onChange={
                                                            handleChangeCountry3
                                                        }
                                                    />
                                                    <FormHelperText>
                                                        {t(
                                            ...
                                            <FormGroup className="FormGroupAddress">
                                                <FormControl>
                                                    ...
                                                    <Select
                                                        ...
                                                        value={
                                                            state.selectedShippingAddressStateEdit2
                                                        }
                                                        options={
                                                            state.selectedShippingStateArray
                                                        }
                                                        onChange={(
                                                            selectedOption
                                                        ) => {
